...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\SW[1]~input_o\ & (\SW[3]~input_o\ & (\SW[2]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\SW[1]~input_o\ & (\SW[3]~input_o\ & ((\SW[2]~input_o\) # (\SW[0]~input_o\))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\SW[1]~input_o\ & ((\SW[3]~input_o\) # ((\SW[2]~input_o\ & \SW[0]~input_o\)))) # (!\SW[1]~input_o\ & (\SW[3]~input_o\ & (\SW[2]~input_o\ & \SW[0]~input_o\)))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\SW[1]~input_o\ & ((\SW[3]~input_o\) # ((\SW[2]~input_o\) # (\SW[0]~input_o\)))) # (!\SW[1]~input_o\ & (\SW[3]~input_o\ & ((\SW[2]~input_o\) # (\SW[0]~input_o\))))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\SW[1]~input_o\ & (((!\SW[0]~input_o\)))) # (!\SW[1]~input_o\ & ((\SW[3]~input_o\) # ((\SW[2]~input_o\ & \SW[0]~input_o\))))
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (!\SW[1]~input_o\ & ((\SW[3]~input_o\) # ((\SW[2]~input_o\) # (\SW[0]~input_o\))))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\SW[1]~input_o\) # (\SW[0]~input_o\)
